...
public class CnmPreferences {
	// Preference Define
	public final String CNM_PREFERENCE 			= "cnm_prefernce";
	...
	// authenticate adult -----------------------------------------------------------------
	public void saveAuthenticateAdult(Context context, boolean value) {
		SharedPreferences pref = context.getSharedPreferences(CNM_PREFERENCE, mode);
		SharedPreferences.Editor editor = pref.edit();
		
		editor.putBoolean(AUTHENTICATE_ADULT, value);
		editor.commit();
	}
	public boolean loadAuthenticateAdult(Context context) {
		SharedPreferences pref = context.getSharedPreferences(CNM_PREFERENCE, mode);
		return pref.getBoolean(AUTHENTICATE_ADULT, false);
	}
	...
	public boolean loadConfigVibrateEffect(Context context) {
		SharedPreferences pref = context.getSharedPreferences(CNM_PREFERENCE, mode);
		return pref.getBoolean(CONFIG_VIBRATE_EFFECT, true);
	}
	// config sound effect -----------------------------------------------------------------
	...
	public boolean loadConfigSoundEffect(Context context) {
		SharedPreferences pref = context.getSharedPreferences(CNM_PREFERENCE, mode);
		return pref.getBoolean(CONFIG_SOUND_EFFECT, true);
	}
	// config touch speed -----------------------------------------------------------------
	...
	public boolean loadConfigVodUpdateNoti(Context context) {
		SharedPreferences pref = context.getSharedPreferences(CNM_PREFERENCE, mode);
		return pref.getBoolean(CONFIG_VOD_UPDATE_NOTI, true);
	}
	// config watch reservation notification ----------------------------------------------
	public void saveConfigWatchResNoti(Context context, boolean value) {
		SharedPreferences pref = context.getSharedPreferences(CNM_PREFERENCE, mode);
		SharedPreferences.Editor editor = pref.edit();
	...
	public boolean loadConfigWatchResNoti(Context context) {
		SharedPreferences pref = context.getSharedPreferences(CNM_PREFERENCE, mode);
		return pref.getBoolean(CONFIG_WATCHING_RES_NOTI, true);
	}
