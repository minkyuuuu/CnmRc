...
public class SlideToggleButton extends SlidingDrawer implements Checkable, OnDrawerOpenListener, OnDrawerCloseListener {
...
//	private CallbacksConfig mCallbacksConfig = sDummyCallback;
	...
	public SlideToggleButton(Context context, AttributeSet attr) {
		super(context, attr);
