...
public class SelectionBuilder {
    ...
    public SelectionBuilder groupBy(String groupBy) {
        ...
        mGroupBy.append(groupBy);
    	return this;
    }
    
    public SelectionBuilder table(String table) {
        mTable = table;
        String[] str = getSelectionArgs();
        return this;
    }
    ...
    private void assertSelection() {
    	if (mSelection.length() > 0) {
    		throw new IllegalStateException("Table only be specified");
    	}
    }
    ...
    /**
     * Return groupBy string for current internal state.
     */
    public String getGroupBy() {
        return mGroupBy.toString();
    }
    ...
    public Cursor query(SQLiteDatabase db, String[] columns, String groupBy,
        ...
        return db.query(mTable, columns, getSelection(), getSelectionArgs(), getGroupBy(), having,
                orderBy, limit);
    }

    /**
     * Execute insert using Table and ContentValeus
     */
    public long insert(SQLiteDatabase db, ContentValues values) {
        assertTable();
        assertSelection();
        //LOGV(TAG, "insert() " + this);
        return db.insertOrThrow(mTable, null, values);
    }
