...
public class TvchSemiDetailAdapter extends ArrayAdapter<ItemTvchSemiDetail> {
	private String TAG = TvchSemiDetailAdapter.class.getSimpleName();
    ...
    public TvchSemiDetailAdapter(Context context, int layoutResId, ArrayList<ItemTvchSemiDetail> arrayList) {
