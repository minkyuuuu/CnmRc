...
public class PopupSearchRecentlyDelete extends DialogFragment implements View.OnClickListener {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		View layout = (View) inflater.inflate(R.layout.popup_ori, container, false);
...
//		mLine2.setText(getString(R.string.popup_search_line_2));
	...
	public void onClick(View v) {
		switch (v.getId()) {
		case R.id.popup_yes:
			Log.i("hwang", "yes button pressed");
			break;
		case R.id.popup_no:
