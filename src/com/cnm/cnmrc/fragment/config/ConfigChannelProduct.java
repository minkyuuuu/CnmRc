...
public class ConfigChannelProduct extends Fragment implements View.OnClickListener {

	public static ConfigChannelProduct newInstance(String areaCode, String areaName) {
		ConfigChannelProduct f = new ConfigChannelProduct();
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		noClickBelowLayout = (LinearLayout) layout.findViewById(R.id.product_no_click_below_layout);
...
//				adapter.notifyDataSetChanged();
	...
	public Animation onCreateAnimation(int transit, boolean enter, int nextAnim) {
		...
		anim.setAnimationListener(new AnimationListener() {
			...
			public void onAnimationEnd(Animation animation) { showProduct(); }
