...
public class RcNumericPad extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		cnm = (CnmApplication) getActivity().getApplicationContext();
	...
	public void onClick() {
		...
		boolean check = cnm.getCnmPrefernce().loadFirstConnectGtv(getActivity());
		if (!check) {
