...
import com.cnm.cnmrc.parser.SearchNaverList;
import com.cnm.cnmrc.parser.SearchNaverParser;
import com.cnm.cnmrc.util.Util;

public class SearchNaverSub extends Fragment implements View.OnClickListener {

	public static SearchNaverSub newInstance(String search) {
		SearchNaverSub f = new SearchNaverSub();
	...
	long elapsedTime;
	SearchNaverList list;
	SearchNaverAdapter adapter;
	ArrayList<SearchNaver> mResult = null;

	private class SearchNaverAsyncTask extends AsyncTask<String, Void, ArrayList<SearchNaver>> {
		@Override
		protected void onPreExecute() {
			super.onPreExecute();
		}

		protected ArrayList<SearchNaver> doInBackground(String... params) {
		...
		@Override
		protected void onPostExecute(ArrayList<SearchNaver> result) {
			mResult = result;
