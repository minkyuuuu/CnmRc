...
public class SearchTvchSemi extends Fragment implements View.OnClickListener  {
	
	public static SearchTvchSemi newInstance(String search) {
		SearchTvchSemi f = new SearchTvchSemi();
	...
	long elapsedTime;
	ItemSearchProgramList list;
	SearchTvchSemiAdapter adapter;
	ArrayList<ItemSearchProgram> mResult = null;
	
	private class SearchProgramAsyncTask extends AsyncTask<String, Void, ArrayList<ItemSearchProgram>> {
		@Override
		protected void onPreExecute() {
			super.onPreExecute();
		}

		protected ArrayList<ItemSearchProgram> doInBackground(String... params) {
		...
		@Override
		protected void onPostExecute(ArrayList<ItemSearchProgram> result) {
			mResult = result;
