...
/**
 * A widget that imitates a Dpad that would float on top of the UI. Dpad is
 * being simulated as a touch area that recognizes slide gestures or taps for
 * OK.
 * <p>
...
public final class SoftDpad extends ImageView {
	...
	public interface DpadListener {
		 ...
		 * 
		 * @param direction
		 *            the direction in which the Dpad was moved
		 * @param pressed
		 *            {@code true} to represent an event down
		 */
	...
	public enum Direction {
		 ...
		 * @hide
		 */
		IDLE(false), CENTER(false), RIGHT(true), LEFT(true), UP(true), DOWN(true);
	...
	/**
	 * Radius of the area around touchable area where events get caught and
	 * ignored.
	 */
	...
	public boolean onTouchEvent(MotionEvent event) {
		Log.e("hwang-tvremote", "SoftDpad MotionEvent");
...
//				return true;
	 ...
	 * 
	 * @param x
	 *            x-coordinate form the top left of the screen
	 * @param y
	 *            y-coordinate form the top left of the screen
	 * @param r
	 *            radius of the circle we are testing
	 * @return {@code true} if event is outside the Dpad
	 */
	private boolean quickDismissEvent(int x, int y, int r) {
		return (x < getCenterX() - r || x > getCenterX() + r || y < getCenterY() - r || y > getCenterY() + r);
	}

	/**
	 * Returns {@code true} if the touch event is outside a circle centered on
	 * the idle position of the Dpad and of a given radius
	 * 
	 * @param x
	 *            x-coordinate of the touch event form the top left of the
	 *            screen
	 * @param y
	 *            y-coordinate of the touch event form the top left of the
	 *            screen
	 * @param r
	 *            radius of the circle we are testing.
	...
	/**
	 * Returns {@code true} if the touch event is outside the area where the
	 * Dpad is when idle, the touchable area.
	 * 
	 * @param x
	 *            x-coordinate form the top left of the screen
	 * @param y
	...
	/**
	 * Returns {@code true} if the dpad has moved enough from its idle position
	 * to stop being interpreted as a click.
	 * 
	 * @param dx
	 *            movement along the x-axis from the idle position
	 * @param dy
	 *            movement along the y-axis from the idle position
	 ...
	 * 
	 * @param dx
	 *            x-coordinate form the idle position of Dpad
	 * @param dy
	 *            y-coordinate form the idle position of Dpad
	 ...
	 * 
	 * @param move
	 *            the direction in witch the event should be sent.
	 * @param pressed
