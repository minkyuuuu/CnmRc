...
//		}
	...
	private final void showSwitchBoxActivity() {
		Log.d("hwang-tvremote", "BaseActivity : showSwitchBoxActivity()");

		disconnect();
		startActivityForResult(DeviceFinder.createConnectIntent(this, getConnectionManager().getTarget(), getConnectionManager().getRecentlyConnected()), CODE_SWITCH_BOX);
	}
